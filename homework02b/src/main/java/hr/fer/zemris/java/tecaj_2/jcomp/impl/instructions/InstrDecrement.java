 ...
 * <code>DECREMENT registar</code> registar--
 * 
 */
public class InstrDecrement implements Instruction {

	/**
	 * Varijabla u koju se sprema index registra naredbe <code>DECREMENT</code>
	 */
	 ...
	 * 
	 * @param arguments
	 *            Registar kojem se smanjuje vrijednost za 1
	 */
	...
	public boolean execute(Computer computer) {
		...
		try {
			...
			throw new ClassCastException("U registru mora biti broj");
		}
		return false;
	}
}
