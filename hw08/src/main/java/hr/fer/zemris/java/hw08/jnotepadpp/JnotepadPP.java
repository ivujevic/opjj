...
import hr.fer.zemris.java.hw08.jnotepadpp.elements.Function;
import hr.fer.zemris.java.hw08.jnotepadpp.elements.TabDesctiptor;
import hr.fer.zemris.java.hw08.jnotepadpp.translator.FormLocalizationProvider;
...
import hr.fer.zemris.java.hw08.jnotepadpp.translator.GUI.LJMenu;
...
public class JnotepadPP extends JFrame {
	 ...
	 */
	protected final DocumentListener makeListener() {
	 ...
	 */
	protected final void textAreaChange(final JTextArea textArea) {
	...
	private void initGUI() {
		...
		LJMenu language = new LJMenu("Language", flp);
		menuBar.add(language);

		ButtonGroup group = new ButtonGroup();
		JRadioButtonMenuItem english = new JRadioButtonMenuItem(function.get("English"));
		group.add(english);
		language.add(english);

		JRadioButtonMenuItem croatian = new JRadioButtonMenuItem(function.get("Croatian"));
		group.add(croatian);
		language.add(croatian);
		croatian.setSelected(true);
		pack();
	}
