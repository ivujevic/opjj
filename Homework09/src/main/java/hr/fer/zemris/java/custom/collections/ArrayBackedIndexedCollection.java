...
public class ArrayBackedIndexedCollection {
	...
	/**
	 * Kreira novi <code>ArrayBackedIndexedCollection</code> veliciine <code>initialCapacity</code>
	 * 
	 * @param initialCapacity
	 *            Početna veličina
	 * @throws Greška
	 *             ako je kapacitet manji od 1
	 */
	 ...
	 * 
	 * @param value
	 *            Vrijednost koja se sprema
	 * @throws Greska
	 *             ako je vrijednost <code>null</code>
	 */
	 ...
	 * 
	 * @param index
	 *            Mjesto s kojeg se brise podatak
	 */
	 ...
	 * 
	 * @param value
	 *            Podatak koji se umece
	 * @param position
	 *            Pozicija na koju se umece
	 */
