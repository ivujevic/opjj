...
public class Example1 {
	...
	public static void main(String[] args) {
		...
		ilustrirajLazy(emf, blogEntryID);
	...
	private static void ilustrirajLazy(EntityManagerFactory emf, Long blogEntryID) {
		EntityManager em = emf.createEntityManager();
		em.getTransaction().begin();
		
		BlogEntry blogEntry = em.find(BlogEntry.class, blogEntryID);
		
		System.out.println("Ucitao sam element s ID " + blogEntry.getId());
		System.out.println("Ima " + blogEntry.getComments().size() + " deca");
